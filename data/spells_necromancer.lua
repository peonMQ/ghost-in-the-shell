return {
  ...
  nec_poison_dot = {
      ...
      "Envenomed Bolt",                           -- L51 Envenomed Bolt (110 DD, 146  hp/tick, resist adj -10 poison)
  ...
  nec_disease_dot = {
      ...
      "Cessation of Cor",                         -- L56 Cessation of Cor (100 hp/tick, -50 str, -19-21 ac, cost 250 mana)
