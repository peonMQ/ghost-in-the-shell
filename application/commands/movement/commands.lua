...
require('application/commands/movement/lockpick_nearest_door')
require('application/commands/movement/nav_to_command')
require('application/commands/movement/port_command')
require('application/commands/movement/stick_command')
require('application/commands/movement/advpath_command')
require('application/commands/movement/travelto_command')