return {
  ["Base EverQuest"] = {
    ...
    ["Tinmizer's Wunderwerks"] = "dragonscalea",
  ...
  ["Lost Dungeons of Norrath"] = {
    ["The Cauldron of Lost Souls"] = "guka",
    ["The Bloodied Quarries"] = "ruja",
    ["The Sunken Library"] = "taka",
    ["The Silent Gallery"] = "mira",
    ["The Forlorn Caverns"] = "mmca",
    ["The Drowning Crypt"] = "gukb",
    ["The Halls of War"] = "rujb",
    ["The Shifting Tower"] = "takb",
    ["The Maw of the Menagerie"] = "mirb",
    ["The Dreary Grotto"] = "mmcb",
    ["The Ancient Aqueducts"] = "gukc",
    ["The Wind Bridges"] = "rujc",
    ["The Fading Temple"] = "takc",
    ["The Spider Den"] = "mirc",
    ["The Asylum of Invoked Stone"] = "mmcc",
    ["The Mushroom Grove"] = "gukd",
    ["The Gladiator Pits"] = "rujd",
    ["The Royal Observatory"] = "takd",
    ["The Hushed Banquet"] = "mird",
    ["The Chambers of Eternal Affliction"] = "mmcd",
    ["The Foreboding Prison"] = "guke",
    ["The Drudge Hollows"] = "ruje",
    ["The River of Recollection"] = "take",
    ["The Frosted Halls"] = "mire",
    ["The Sepulcher of the Damned"] = "mmce",
    ["The Chapel of the Witnesses"] = "gukf",
    ["The Fortified Lair of the Taskmasters"] = "rujf",
    ["The Sandfall Corridors"] = "takf",
    ["The Forgotten Wastes"] = "mirf",
    ["The Ritualistic Summoning Grounds"] = "mmcf",
    ["The Root Garden"] = "gukg",
    ["The Hidden Vale"] = "rujg",
    ["The Balancing Chamber"] = "takg",
    ["The Heart of the Menagerie"] = "mirg",
    ["The Cesspits of Putrescence"] = "mmcg",
    ["The Accursed Sanctuary"] = "gukh",
    ["The Blazing Forge"] = "rujh",
    ["The Sweeping Tides"] = "takh",
    ["The Morbid Laboratory"] = "mirh",
    ["The Aisles of Blood"] = "mmch",
    ["The Arena of Chance"] = "ruji",
    ["The Antiquated Palace"] = "taki",
    ["The Theater of Imprisoned Horrors"] = "miri",
    ["The Halls of Sanguinary Rites"] = "mmci",
    ["The Barracks of War"] = "rujj",
    ["The Prismatic Corridors"] = "takj",
    ["The Grand Library"] = "mirj",
    ["The Infernal Sanctuary"] = "mmcj"
  },
  ["Gates of Discord"] = {
    ["Abysmal Sea"] = "abysmal",
  ...
  ["Veil of Alaris"] = {
    ...
    ["Beast's Domain"] = "beastdomain",
    ["City of Bronze"] = "cityofbronze",
    ["East Sepulcher"] = "eastsepulcher",
    ["Sarith City"] = "sarithcity",
    ["Rubak Oseka"] = "rubak",
    ["Resplendent Temple"] = "resplendent",
    ["Pillars of Alra"] = "pillarsalra",
    Windsong = "windsong",
    ["Palatial Guidhall"] = "guildhalllrg",
    ["Sepulcher of Order"] = "sepulcher",
    ["West Sepulcher"] = "westsepulcher",
    ["Shadowed Mount"] = "shadowedmount",
    ["Grand Guild Hall"] = "guildhalllrg",
    ["Greater Guild Hall"] = "guildhallsml",
    ["One Bedroom House Interior"] = "plhdkeinteriors1a3",
    ["Three Bedroom House Interior"] = "plhdkeinteriors3a3",
    ["Modest Guild Hall"] = "guildhall3"
  },
  ["Rain of Fear"] = {
  ...
  ["The Broken Mirror"] = {
    ["Sul Vius: Demiplane of Life"] = "exalted",
    ["Sul Vius: Demiplane of Decay"] = "exaltedb",
    ["Crypt of Sul"] = "cosul",
    ["Ruins of Lxanvom"] = "codecayb",
    ["The Plane of Health"] = "pohealth"
  },
  ["Empires of Kunark"] = {
    Chardok = "chardoktwo",
  ...
  ["Ring of Scale"] = {
    ["Sathir's Tomb"] = "charasisb",
    Gorowyn = "gorowyn",
    ["Howling Stones"] = "charasistwo",
    ["Skyfire Mountains"] = "skyfiretwo",
    ["The Overthere"] = "overtheretwo",
    ["Veeshan's Peak"] = "veeshantwo"
  },
  ["The Burning Lands"] = {
    ["Esianti: Palace of the Winds"] = "esianti",
    ["Plane of Smoke"] = "trialsofsmoke",
    ["Stratos: Zephyr's Flight"] = "stratos",
    ["Empyr: Realms of Ash"] = "empyr",
    ["AAlishai: Palace of Embers"] = "aalishai",
    ["Mearatas: The Stone Demesne"] = "mearatas",
    ["The Chamber of Tears"] = "chamberoftears"
  },
  ["Gnome Memorial Mountain"] = {
    ["Gnome Memorial Mountain"] = "gnomemtn"
  },
  ["Torment of Velious"] = {
    ["The Eastern Wastes"] = "eastwastestwo",
    ["The Tower of Frozen Shadow"] = "frozenshadowtwo",
    ["The Ry`Gorr Mines"] = "crystaltwoa",
    ["The Great Divide"] = "greatdividetwo",
    ["Velketor's Labyrinth"] = "velketortwo",
    ["Kael Drakkel"] = "kaeltwo",
    ["Crystal Caverns"] = "crystaltwob"
  },
  ["Claws of Veeshan"] = {
    ["The Sleeper's Tomb"] = "sleepertwo",
    ["Dragon Necropolis"] = "necropolistwo",
    ["Cobalt Scar"] = "cobaltscartwo",
    ["The Western Wastes"] = "westwastestwo",
    Skyshrine = "skyshrinetwo",
    ["The Temple of Veeshan"] = "templeveeshantwo"
  },
  ["Terror of Luclin"] = {
    ["Maiden's Eye"] = "maidentwo",
    ["Umbral Plains"] = "umbraltwo",
    ["Ka Vethan"] = "akhevatwo",
    ["Vex Thal"] = "vexthaltwo",
    ["Shadow Valley"] = "shadowvalley",
    ["Basilica of Adumbration"] = "basilica",
    Bloodfalls = "bloodfalls",
    ["Coterie Chambers"] = "maidenhouseint"
  },
  ["Night of Shadows"] = {
    ["Ruins of Shadow Haven"] = "shadowhaventwo",
    ["Shar Vahl, Divided"] = "sharvahltwo",
    ["Paludal Depths"] = "paludaltwo",
    ["Shadeweaver's Tangle"] = "shadeweavertwo",
    ["Darklight Caverns"] = "darklightcaverns",
    Deepshade = "deepshade",
    ["Firefall Pass"] = "firefallpass",
    ["Hollowshade Moor"] = "hollowshadetwo"
  }
}