...
local magicianAirPetSpells = {
  -- air pets:
  "Elementalkin: Air",        -- L02
  "Elementaling: Air",        -- L06
  "Elemental: Air",           -- L10
  "Minor Summoning: Air",     -- L14
  "Lesser Summoning: Air",    -- L18
  "Summoning: Air",           -- L22
  "Greater Summoning: Air",   -- L26
  "Minor Conjuration: Air",   -- L31
  "Lesser Conjuration: Air",  -- L36
  "Conjuration: Air",         -- L41
  "Greater Conjuration: Air", -- L49
  "Vocarate: Air",            -- L54
  "Greater Vocaration: Air",  -- L60
}
...
local magAir = {
  FocusItem="Staff of Elemental Mastery: Air",
  Spells = magicianAirPetSpells
}

local magWater = {
  FocusItem="Staff of Elemental Mastery: Water",
  Spells = magicianWaterPetSpells
}

---@class PetTypeSpells
---@field FocusItem? fun(string?):string|nil 
...
local function getPetSummonSpell(type)
  ...
  return petspell, petTypeSpell.FocusItem(type)
end